...
# Importing csv module, sys and cs50
import csv
import sys
import cs50
...
print("""
Welcome to fetch_features!

This program needs the Biophyton and cs50 modules. If you don't have
those modules, please visit https://biopython.org/ and
https://github.com/cs50/python-cs50 for more information.

This program works by providing a list of accesion numbers in a txt
file. You can create one in Excel by saving the file as txt.
The list needs a header, if it doesn't have one the first accession
...
infile = cs50.get_string('Provide the name of you infile.txt: ')
...
# Loop to create the list of accession numbers
for start in range(0, count, batch_size):
    ...
    for set in range(start, end):
        set_list.append(list_accessions[counter_accessions].replace('\n', ''))
...
Entrez.email = cs50.get_string("Provide your email address to the NCBI: ")
